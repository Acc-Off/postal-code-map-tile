...
| `public/combined/` | Intermediate combined image of all 6 tiles |
| `public/metadata.json` | Metadata produced during tile generation |
| `public/index.html` | Local Leaflet viewer for verification |

## Publishing Tiles

The generated output under `public/` is hosted on **Cloudflare Pages**.  
Tile URL format:

```
https://<pages-domain>/tiles/{z}/{x}/{y}.png
```
...
L.tileLayer('https://<pages-domain>/tiles/{z}/{x}/{y}.png', {
...
Config.CustomMaps = {
    {
        ...
        url         = "https://<pages-domain>/tiles/{z}/{x}/{y}.png",
        center      = { 450, 1650 },
        topLeft     = { -4140, 8400 },
        bottomRight = { 4860, -5100 },
